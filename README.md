...
* CQMS is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as CQMS is mean to act as a starting point for Android Applications.
...
signed with a different key.  Manually uninstall CQMS from your device and
...
CQMS is a result of a template project I've developed over the years as well as
...
CQMS is built on the awesome [Parse.com API](http://www.parse.com/)
