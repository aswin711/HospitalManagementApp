...
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_CREATED_ON;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_HOSPITAL_ID;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_ID;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_INCIDENTTYPE_REF;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_NAME;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_SERVER_ID;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_SPECIALTY_REF;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_STATUS_CODE;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_UNIT_REF;
import static com.xose.cqms.event.sqlite.DatabaseHelper.Columns.KEY_UPDATED_ON;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_CONSUTANT;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_CORRECTIVE_ACTION;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_DEPARTMENT;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_DESCRIPTION;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_DESIGNATION;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_DIAGNOSIS;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_EVENT_REPORT_REF;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_FNAME;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_GENDER;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_HEIGHT;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_HOSPITAL_NUMBER;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_INCIDENT_LOCATION;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_INCIDENT_NUMBER;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_INCIDENT_TIME;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_LNAME;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_PATIENT_TYPE;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_PERSONNEL_TYPE_CODE;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_PERSON_DOB;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_PERSON_INVOLVED_REF;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_PERSON_NAME;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_REPORTED_BY_REF;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_REPORTED_ON;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_STAFF_ID;
import static com.xose.cqms.event.sqlite.DatabaseHelper.EventReportKey.KEY_WEIGHT;
import static com.xose.cqms.event.sqlite.DatabaseHelper.IncidentReportKey.KEY_INCIDENT_LEVEL;
import static com.xose.cqms.event.sqlite.DatabaseHelper.IncidentReportKey.KEY_INCIDENT_TYPE_REF;
import static com.xose.cqms.event.sqlite.DatabaseHelper.IncidentReportKey.KEY_MEDICAL_REPORT;

import  static com.xose.cqms.event.sqlite.DatabaseHelper.DrugReactionKey.*;
