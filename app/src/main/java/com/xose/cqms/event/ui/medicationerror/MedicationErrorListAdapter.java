...
import com.xose.cqms.event.ui.base.AlternatingColorListAdapter;
 ...
 */
public class MedicationErrorListAdapter extends AlternatingColorListAdapter<MedicationError> {
    /**
     * @param inflater
     * @param items
     * @param selectable
     */
    public MedicationErrorListAdapter(final LayoutInflater inflater, final List<MedicationError> items,
