...
public class MedicationErrorListActivity extends BootstrapFragmentActivity {
    ...
    protected Activity getActivity() {
        return MedicationErrorListActivity.this;
    }
    ...
    private void initScreen() {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.incident_list_container, new MedicationErrorListFragment())
                .commit();
    }
}
